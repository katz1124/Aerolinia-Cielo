...
import com.cielo.aerolinea.client.MailClient;
import com.cielo.aerolinea.client.SeatSelectionClient;
...
public class VistaServiceImpl implements  VistaService{
    ...
    @Autowired
    SeatSelectionClient seatSelectionClient;
    @Autowired
    ...
    public SeatSelectionModel getSeatSelectionModel(int idReservation, String seat) {
        SeatSelectionModel seatSelectionModel=seatSelectionClient.selectSeat(idReservation,seat).getBody();
        return seatSelectionModel;
    }
    //checkin service
    @Override
    public void sendTicket(int boardingPassId) throws DocumentException, IOException {
        mailClient.sendTicket(boardingPassId);
    }
}
